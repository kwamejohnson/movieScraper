...
module.exports = (function(){
	return {
			...
			showMovies: function(request, response){
					...
					request(url, (function() { return function(err, resp, body) {
							...
							var counter = 0
															$('.showtimes-movie-detail .showtimes-movie-rating-runtime').each(function(movie) {
																...
																// duration = duration[5] + duration[6]
																duration = (parseInt(duration[0]* 60) + parseInt(duration[5] + duration[6])) + " mins"
									...
									for (var j = 0; j < movies.length; j++) {
										...
										movies[j].showtimes = showtimes[j]
									}
